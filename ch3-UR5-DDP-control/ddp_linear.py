...
if __name__=='__main__':
    ...
    # The task is defined by a quadratic cost plus a control regularization: sum_{i=0}^N (0.5 x' H_{xx,i} x + h_{x,i} x + h_{s,i} )+ sum_{i=0}^{N-1}(lmbda ||u_i||).
